...
const ElectricityBolt = (props: AssetProps) => {
  const [yellow200] = useToken("colors", ["yellow.200"]);

  return (
    <svg
      width={props.sizeInPx || "40px"}
      height={props.sizeInPx || "40px"}
      viewBox="0 0 25 25"
      xmlns="http://www.w3.org/2000/svg"
    >
      <filter id="electricitySvgFilter" primitiveUnits="objectBoundingBox">
      ...
      <g clipPath="url(#clip0_4_123)" filter="url(#electricitySvgFilter)">
        <path
