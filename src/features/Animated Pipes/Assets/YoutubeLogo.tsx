...
const YoutubeLogo = (props: AssetProps) => {
  return (
    <svg
      width={props.sizeInPx || "25"}
      height={props.sizeInPx || "25"}
      viewBox="0 0 25 17"
      xmlns="http://www.w3.org/2000/svg"
    >
      <filter id="youtubeSvgFilter" primitiveUnits="objectBoundingBox">
        <feFlood floodColor={`#FF0000`}>
          <animate
            id="spt2"
