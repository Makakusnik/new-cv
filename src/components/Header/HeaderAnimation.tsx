  ...
  return (
    ...
    >
      ...
      <LayerContainer top="66px">
        ...
        <HorizontalPipe right="225px" width="165px" />
        <KneeJoint left="135px" />
        <KneeJoint right="390px" rotate="270" />
        <LayerContainer top="18px">
          ...
          <VerticallPipe right="390px" height="60px" />
        </LayerContainer>
      </LayerContainer>
    </Container>
  );
...
const KneeJoint = (props: any) => {
  return (
    <Box
      ...
      borderTop="4px solid "
      borderTopColor="primaryBlue.800"
      borderRight="4px solid "
      borderRightColor="primaryBlue.800"
      _after={{
        content: '""',
        height: "4px",
        width: "4px",
        bgColor: "primaryBlue.800",
        position: "absolute",
        bottom: 0,
        borderTopRightRadius: "50%",
      }}
      bgColor="primaryBlue.600"
      w="18px"
      h="18px"
...
const HorizontalPipe = (props: any) => {
  return (
    <Box
      ...
      borderBottomColor="primaryBlue.800"
    ></Box>
  );
};
...
const VerticallPipe = (props: any) => {
  return (
    <Box
      ...
      borderLeftColor="primaryBlue.800"
      borderRight="4px solid "
      borderRightColor="primaryBlue.800"
    />
  );
